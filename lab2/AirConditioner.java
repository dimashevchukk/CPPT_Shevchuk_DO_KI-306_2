...
public class AirConditioner
{
     ...
     * Constructor
     * */
    AirConditioner(String model, String mode, int cost, int temperature, boolean enabled)
    {
        this.model = model;
        this.mode = mode;
        this.cost = cost;
    ...
    protected void changeInfo(String model, String mode, int cost, int temperature, boolean enabled)
    {
        this.model = model;
        this.mode = mode;
        this.cost = cost;
